...
def add_sensor(sensor_id, latitude, longitude, elevation, coord_sys, **kwargs):
    """
    ...
    Args:
        ...
        latitude (number): The latitude of the sensor/ observatory location.
        longitude (number): The longitude of the sensor/ observatory location.
        elevation (number): The elevation (in metres) of the sensor/ observatory.
        coord_sys (str): The type/ kind of coordinates used by the sensor.
                            Examples: "XYZF", "HEZF"
        **kwargs: any other relevant info to add about the sensor.
    """
    sensor_info = {}
